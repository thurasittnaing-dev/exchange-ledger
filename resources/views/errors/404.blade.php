...
@section('content')
    <div class="container d-flex flex-column justify-content-center align-items-center" style="min-height: 80vh;">
        <div class="text-center">
            ...
            <!-- Error Message -->
            <h2 class="h4 fw-semibold mb-3">Oops! Page not found</h2>

            <!-- Helpful Description -->
            <p class="text-muted mb-4 mx-auto" style="max-width: 500px;">
                The page you're looking for doesn't exist or has been moved. If you think this is a mistake, please contact
                support.
            </p>
